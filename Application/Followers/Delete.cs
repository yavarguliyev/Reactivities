...
namespace Application.Followers
{
  public class Delete
  {
    public class CommandDeleteFollowers : IRequest
    {
      public string Username { get; set; }
    }

    public class Handler : IRequestHandler<CommandDeleteFollowers>
    {
      ...
      public async Task<Unit> Handle(CommandDeleteFollowers request, CancellationToken cancellationToken)
      {
