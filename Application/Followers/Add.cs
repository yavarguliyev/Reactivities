...
namespace Application.Followers
{
  public class Add
  {
    public class CommandAddFollowers : IRequest
    {
      public string Username { get; set; }
    }

    public class Handler : IRequestHandler<CommandAddFollowers>
    {
      ...
      public async Task<Unit> Handle(CommandAddFollowers request, CancellationToken cancellationToken)
      {
