...
import ActivtyListItemAttendees from './ActivtyListItemAttendees';
...
const ActivityListItem: React.FC<{ activity: IActivity }> = ({ activity }) => {
  ...
  return (
    <Segment.Group>
        ...
        <Item.Group>
          <Item>
            ...
            <Item.Content>
              ...
              {activity.isGoing && !activity.isHost && (<Item.Description><Label basic color='green' content='You are going to this activity' /></Item.Description>)}
            </Item.Content>
          </Item>
        </Item.Group>
      </Segment>
      ...
      <Segment secondary>
        <ActivtyListItemAttendees attendees={activity.attendees} />
      </Segment>
      <Segment clearing>
